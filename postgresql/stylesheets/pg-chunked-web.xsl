...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:import href="/opt/local/share/xsl/docbook-xsl/xhtml/chunk-common.xsl"/>
  <xsl:import href="pg-chunk-common.xsl"/>
  <xsl:import href="/opt/local/share/xsl/docbook-xsl/xhtml/manifest.xsl"/>
  ...
  <xsl:import href="/opt/local/share/xsl/docbook-xsl/xhtml/profile-chunk-code.xsl"/>
